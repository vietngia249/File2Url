...
```bash
curl -X POST https://file2url-nsdd.onrender.com/upload \
  -F "file=@/đường_dẫn_tới_ảnh.jpg" \
  -F "expire=3"
```
...
```text
https://file2url-nsdd.onrender.com/file/{uuid}
https://file2url-nsdd.onrender.com/file/{uuid}?download=1
```
